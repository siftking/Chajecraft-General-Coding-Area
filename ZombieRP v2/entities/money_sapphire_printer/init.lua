...
local minPrint 			= 40							-- 	The minimum amount the printer can generate.
local maxPrint			= 45							-- 	The maximum amount the printer can generate.
local upgradedExtra 	= maxPrint * 0.5				-- 	If the printer is upgraded, how much extra will they get?
local printerColor 		= Color( 0, 0, 255, 255 )	--  The color of the actual printer prop.
