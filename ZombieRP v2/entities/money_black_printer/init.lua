...
local minPrint 			= 300							-- 	The minimum amount the printer can generate.
local maxPrint			= 400							-- 	The maximum amount the printer can generate.
local upgradedExtra 	= maxPrint * 0.5				-- 	If the printer is upgraded, how much extra will they get?
local printerColor 		= Color( 70, 70, 70, 255 )		--  The color of the actual printer prop.
