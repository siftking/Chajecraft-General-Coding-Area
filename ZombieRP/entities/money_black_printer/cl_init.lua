...
-- [ ALTER THESE VALUES ] ----
local LabelBackgroundColor 	= Color( 0, 0, 0, 255 )				-- The color of the frame where your name and type of printer are listed.
local LabelTextColor 		= Color( 255, 255, 255, 255 )		-- The color of the text where your name and type of printer are listed.
------------------------------
